...
export default function Messages(props: MessagesProps) {
	...
	async function fetchMe() {
		let msgs: UserAndPost[] = await (
			await fetch(`https://axumtwit.shuttleapp.rs/user/${encodeURI(props.user)}`)
		).json();
		return msgs;
	}

	async function fetchMsgs() {
		let msgs: UserAndPost[] = await (await fetch("https://axumtwit.shuttleapp.rs/msgs")).json();
		return msgs;
	}
	...
	const delete_msg = createMutation(() => {
		return {
			mutationFn: async () => {
				...
				await fetch("https://axumtwit.shuttleapp.rs/delete_msg", {
					method: "POST",
					headers: {
	...
	const like_msg = createMutation(() => {
		return {
			mutationFn: async () => {
				...
				await fetch("https://axumtwit.shuttleapp.rs/like_msg", {
					method: "POST",
					headers: {
						"Content-Type": "application/json",
					},
